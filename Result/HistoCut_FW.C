...
void HistoCut_FW(Int_t CentralityClasses, Int_t CE){
	TFile *f1 = new TFile("/home/vad/centrality/build/Result/glauber_qa_FW.root");
	...
	cout<<"min="<<min<<endl;
	Double_t integral = FitHisto->Integral(1,bins);
	cout<<"integral="<<integral<<endl;

	TFile *f = new TFile("HistoCutResult_FW.root", "recreate");
	...
	Int_t Ncc, BIN;
	Float_t MinPercent, MaxPercent, MinBorder, MaxBorder;
